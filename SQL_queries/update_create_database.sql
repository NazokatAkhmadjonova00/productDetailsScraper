...
CREATE TABLE operator_identification (
    ...
    operator_uuid TEXT NOT NULL REFERENCES operators(uuid),
...
CREATE TABLE device_basic_udi_detail (
    ...
    eudamed_id TEXT NOT NULL REFERENCES devices(eudamed_id),
...
CREATE TABLE certificates (
    ...
    manufacturer_actor_id TEXT,
    auth_rep_actor_id TEXT,
